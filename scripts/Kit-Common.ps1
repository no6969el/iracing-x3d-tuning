<#
    ...
    WHAT READS WHAT
      ...
      $HardFault*         names/patterns for FullTrace + Scan-Stutter-Events
                          + Preflight-Check (session name, providers,
                          CSV patterns, column names)

    Analysis, recovery and console helpers live in HardFault-Common.ps1.
    Elevate / log / privilege helpers live in RaceQuiet-Common.ps1.
